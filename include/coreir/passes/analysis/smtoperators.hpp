...
namespace CoreIR {
  namespace Passes {
    ...
    string SMTReg(string context, SmtBVVar in, SmtBVVar clk, SmtBVVar out, string init);
    string SMTRegPE(string context, SmtBVVar in, SmtBVVar clk, SmtBVVar out, SmtBVVar en, string init);
