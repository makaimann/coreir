...
int main() {
  ...
  Args wargs({{"width",c->argUint(19)}});
  
  // Define random module with subs
  Module* ms = prj->newModuleDecl("SNRTestSub",c->Any());
  ModuleDef* def = ms->newModuleDef();
    def->addInstance("c0",sl->getGenerator("const"),wargs,{{"value",c->argUint(5)}});
    def->addInstance("c1",sl->getGenerator("const"),wargs,{{"value",c->argUint(5)}});
    def->addInstance("c2",sl->getGenerator("const"),wargs,{{"value",c->argUint(2)}});
  ...
  def = ma->newModuleDef();
    def->addInstance("c0",sl->getGenerator("const"),wargs,{{"value",c->argUint(0)}});
    def->addInstance("c1",sl->getGenerator("const"),wargs,{{"value",c->argUint(1)}});
    def->addInstance("c2",sl->getGenerator("const"),wargs,{{"value",c->argUint(2)}});
  ...
  pdef = patternC->newModuleDef();
    ...
    pdef->addInstance("c0",sl->getGenerator("const"),wargs,{{"value",c->argUint(31)}});
