...
(bash tools/formal_verification/cvc4_check.sh $WORKINGDIR/equivalence.smt2 | python tools/formal_verification/equivalence_compare.py) > $WORKINGDIR/output.txt
echo " --> Output stored in "$WORKINGDIR/output.txt
